...
import org.talend.repository.items.importexport.ui.wizard.server.ServerWebWizard;
import org.talend.repository.model.IProxyRepositoryService;
import org.talend.repository.ui.actions.AContextualAction;

/**
 */
public class ServerWebAction extends AContextualAction implements IWorkbenchWindowActionDelegate {

    private IStructuredSelection structureSelection;

    public ServerWebAction() {
        super();
        this.setText(Messages.getString("ServerWebAction_title")); //$NON-NLS-1$
    ...
    protected void doRun() {
        ...
        ServerWebWizard wizard = getNewServerWebWizard();
...
//            }
    ...
    protected ServerWebWizard getNewServerWebWizard() {
        return new ServerWebWizard();
    }
