...
import org.talend.repository.items.importexport.ui.wizard.imports.ImportEtlToolWizard;
import org.talend.repository.model.IProxyRepositoryService;
import org.talend.repository.ui.actions.AContextualAction;

/**
 */
public class ImportEtlToolAction extends AContextualAction implements IWorkbenchWindowActionDelegate {

    private IStructuredSelection structureSelection;

    public ImportEtlToolAction() {
        super();
        this.setText(Messages.getString("ImportEtlToolAction_title")); //$NON-NLS-1$
        this.setToolTipText(this.getText());
        this.setImageDescriptor(ImageProvider.getImageDesc(EImage.ETLTOOL_ICON));
    }
    ...
    protected void doRun() {
        ...
        ImportEtlToolWizard wizard = getNewImportEtlToolWizard();
...
//            }
    ...
    protected ImportEtlToolWizard getNewImportEtlToolWizard() {
        return new ImportEtlToolWizard();
    }
