...
import org.talend.repository.items.importexport.ui.wizard.imports.ImportNexusWizard;
import org.talend.repository.model.IProxyRepositoryService;
import org.talend.repository.ui.actions.AContextualAction;

/**
 */
public class ImportNexusAction extends AContextualAction implements IWorkbenchWindowActionDelegate {

    private IStructuredSelection structureSelection;

    public ImportNexusAction() {
        super();
        this.setText(Messages.getString("ImportNexusAction_title")); //$NON-NLS-1$
    ...
    protected void doRun() {
        ...
        ImportNexusWizard wizard = getNewImportNexusWizard();
...
//            }
    ...
    protected ImportNexusWizard getNewImportNexusWizard() {
        return new ImportNexusWizard();
    }
